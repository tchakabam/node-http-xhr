...
NodeHttpXHR.prototype.send = function (data) {
  ...
  if (this._responseType === 'arraybuffer') {
    this._reqOpts.encoding = null;
  }

  var req = makeRequest(this._reqOpts, function onResponse(err, resp, body) {
    ...
    //console.log(`loaded data for ${this._reqOpts.url.href}`)

    if (typeof body === 'string') {
      //console.log('got utf8-data of length:', body.length)
      this._responseText = body;
    } else if (typeof body === 'object') {
      if (!(body instanceof Buffer)) {
        throw new Error('Assertion failed: Response-data should be of `Buffer` type');
      }
      //console.log('got buffer data of size:', body.length);
      this._response = body;
    }
     ...
     * TODO
     *
     * use https://www.npmjs.com/package/xhr-request
     *
     *  or https://github.com/Microsoft/typed-rest-client
     */
